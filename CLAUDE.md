...
Platform settings → Engines → Add engine with endpoint URL `http://host.docker.internal:8080/engine-rest`,
"How EnterpriseGlue connects" = "Connect directly to the engine" and username/password `admin`/`admin`
